...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/page1/page1Module.js',
			'app/modules/page1/page1Ctrl.js',
			'app/modules/page1/page1Route.js',
			'app/modules/page1/page1Service.js',
			'app/modules/page1/page1-test.js',
			'app/modules/page2/page2Module.js',
			'app/modules/page2/page2Ctrl.js',
			'app/modules/page2/page2Route.js',
			'app/modules/page2/page2Service.js',
			'app/modules/page2/page2-test.js',
			'app/modules/page3/page3Module.js',
			'app/modules/page3/page3Ctrl.js',
			'app/modules/page3/page3Route.js',
			'app/modules/page3/page3Service.js',
			'app/modules/page3/page3-test.js',
		],
