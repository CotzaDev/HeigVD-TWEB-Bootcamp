angular.module('bootcamp-app').run(['$templateCache', function($templateCache) {
  'use strict';
  ...
  $templateCache.put('app/modules/page1/page1.html',
    ...
    "    <md-card>\n" +
    "        <md-card-content>\n" +
    "            <h2 class=\"md-title\">Content from: page1 page</h2>\n" +
    "        </md-card-content>\n" +
    "    </md-card>\n" +
    "</div>\n"
  );
  ...
  $templateCache.put('app/modules/page2/page2.html',
    "<div class=\"md-padding\" flex layout-sm=\"column\">\n" +
    "  <h2 class=\"md-title\">Graph with github datas</h2>\n" +
